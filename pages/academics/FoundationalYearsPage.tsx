...
const features = [
    { title: "Good Values", imageUrl: "https://lh3.googleusercontent.com/pw/AP1GczOSmpkUeufM2QpMS31v279cXywEHMnDBFL0Oeu2ZTd0WFFfG7yI9hV2JOviMyNJc7DI42zqKXZFkHvT4REixmQvALTfGe0Swyf1ORKHxyX_Peb9kYaXF5DPNeWniL19zAob6lT8lIEQDBDYhkI1GNIr=w1386-h924-s-no-gm?authuser=1", description: "Through stories and group activities, we teach kindness, sharing, and respect, laying the foundation for empathetic individuals." },
    { title: "Cognitive Skills", imageUrl: "https://lh3.googleusercontent.com/pw/AP1GczMaIVh22sBQydAKXQ1eJsBN_M01dYuR_x7g61525DaSkma4L12MLTgjdbTCMVH3qlFV4jmZIGCawvsPK43p0q6MRYY3gHAg6092ukmvLh9K9H4U-BHhz4qal0p4d1RSnNhp5XQR1ChijVaRITAbDN9S=w1386-h924-s-no-gm?authuser=1", description: "Our puzzles, sorting games, and memory challenges are designed to boost problem-solving abilities and sharpen young minds." },
    { title: "Team Spirit", imageUrl: "https://lh3.googleusercontent.com/pw/AP1GczOBn7lLMBMNzECD_PgyjbZadsCUeA1oQtSnfK7v9jb5ZPZeDdpLAVJv7woJBobPyr3V0VpYf76vov86eakQChM0waP1GP35MbBTk2xqXgMnkGGqckvUJtH0l88S1DsykioDUw3pQiK_sCW0OJSFXRCW=w1386-h924-s-no-gm?authuser=1", description: "Collaborative projects and group play encourage children to work together, communicate, and build strong, positive friendships." },
    { title: "Innovative Learning", imageUrl: "https://lh3.googleusercontent.com/pw/AP1GczMUBUoyVyCRLD-v4BF-b0DMKuMPYNNmuLZxbv0groeAqF7XaEsNmSy9kvqIJHSoZM70vtfs6jrgXTqnTcsBRLyxjL1hG0eOms30HM1hn6u0f0cbUXTkVZRmjhP-50CLjTGQh7csn8uRX9BZWreSIDaF=w1386-h924-s-no-gm?authuser=1", description: "We use smart boards, educational apps, and interactive toys to make learning a modern, engaging, and multi-sensory adventure." },
    { title: "Inquisitive Minds", imageUrl: "https://lh3.googleusercontent.com/pw/AP1GczP-XChJi5ZgP2Na-l0HLQ0fzGEOSkXrz3hkSAp0_G2Dcq9H0gqcME9dHnWmO3Ce8ez8yBqCHm2CLfIFhqd95vUPm3QQBrmOAen7J9V90DD-ujwSqEqBa-PQCriLM_FuwmTEEm1RG5ZRLSe3x49f5fXu=w1386-h924-s-no-gm?authuser=1", description: "We foster curiosity by encouraging questions, hands-on experiments, and exploration, turning every child into a lifelong learner." },
    { title: "Fun Experiences", imageUrl: "https://lh3.googleusercontent.com/pw/AP1GczPoqt29I0o5zuiSGQnr31oU1z300nJ8RRb3MANCgZn6WGat8sudmeF_b_SWkeL5lqKDBHU3XlO1_ar-QEiCJyZSAmCW3xjHs-7QsgeUn_mhbCzApdgeNynTw2jQG2uXtBHiL8uG50QcpOzi8OVhzIY5=w1386-h924-s-no-gm?authuser=1", description: "Learning is a joyful journey! From music and dance to art and outdoor play, we ensure every day is filled with laughter and happy memories." },
];
...
const InfoCard: React.FC<{icon: React.ElementType, title: string, content: string, tags: string[], color: string}> = ({icon: Icon, title, content, tags, color}) => {
    ...
    return (
        <div className="relative bg-white/50 dark:bg-slate-800/50 backdrop-blur-lg border border-white/20 dark:border-slate-700/50 p-8 rounded-2xl shadow-xl overflow-hidden h-full">
             <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/az-subtle.png')] opacity-5 dark:opacity-20"></div>
    ...
    return (
        <div className="relative overflow-hidden">
            ...
            <PageHeader 
                ...
                imageUrl="https://lh3.googleusercontent.com/pw/AP1GczPaPAswWnnbaomcc1LV1TU5qTlVTy-p_hHvYjR0Qcf9MHJ-oGw_aNRwSFwOMz4TT2FMZYzGOeRVA7gP_2eOVA1gPZ9ktAi1Qyga2Dsf9BnWrgw_B5Aohy21lrGoKN_63hRpd4xaK4xn-yp7peo73eus=w1386-h924-s-no-gm?authuser=1"
            />
             <FloatingShapes />
