  ...
  return (
    <div>
            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 bg-white/50 dark:bg-slate-900/50 backdrop-blur-lg border border-white/20 dark:border-slate-700/50 p-8 lg:p-12 rounded-2xl shadow-xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                    <AnimateOnScroll animation="slide-in-from-left" className="lg:w-1/3">
                         <img src="https://lh3.googleusercontent.com/pw/AP1GczMFDY2vDwGV945VVc1SROcAjeCS9H8RPfGW9WM_guEbfjO42AX3okvt9utb0PQkw6X9jGlueYlb_Z38n_G-I175Bfwqgfwmbth2_gfIDiWgZt76mBE3i7WQLgVia09n_lmtmwOs3Yyds0U2sC9cvwts=w1386-h924-s-no-gm?authuser=0" alt="Principal Mrs. Archana Parulekar" className="rounded-xl shadow-2xl w-full" />
                    </AnimateOnScroll>
      ...
      <section 
        ...
        style={{
          backgroundImage: "url('https://lh3.googleusercontent.com/pw/AP1GczOm07cAcEC1BQTnfaXKwrRM4PrCgnvaaTiLF3ILA9cWEWaanq-LEk-JR_ILf-9yibq-L8YLDTqV2cbszFF4V-cEWMOjwPdWIBh_W3ZyzMQQHYnbMrgB7E2yZVCV2DjNr_PGmilFKEZhYc5Vgl1Olawn=w1386-h924-s-no-gm?authuser=0')"
        }}
      >
      ...
      <section className="py-20 lg:py-28">
       ...
       <section className="py-20 lg:py-28 bg-gradient-to-br from-amber-400 to-amber-600 dark:bg-none dark:bg-blue-700/50 dark:backdrop-blur-md dark:border-t dark:border-b dark:border-white/10">
        ...
        <section 
            ...
            style={{ backgroundImage: "url('https://lh3.googleusercontent.com/pw/AP1GczPxxayYGTmVo_WY8cOfQpVGts3nAWG4ef8IB1hoRuZ4qYJ2XDbe1lDIXHRXEguTHUK6fl0iLoVTswGe5TOPLleBJn4-gJaecu0rD3TDHwyUmYaF_Z-jJb6xHUoGdNuhs0kmPwpDvjyVTafu6MwkhhF6=w1646-h924-s-no-gm?authuser=0')" }}
        >
